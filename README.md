...
| ------------------------- | -------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Model AI mặc định         | `GEMINI_MODEL` mặc định là `gemini-2.5-flash`, không phải bản Pro.                                                   | Model miễn phí, hạn mức free-tier rộng, đủ ổn định cho demo học thuật; đổi được qua biến môi trường, không cần sửa code. |
